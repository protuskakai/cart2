...
<body oncontextmenu='return false' class='snippet-body'>
    <div class="container mt-5 d-flex justify-content-center">
        ...
        <div class="card p-3">
            ...
            <br>
            <form action="{{ route('tinypesa2')}}" method="POST">
             @csrf
			<div class="px-5"> <input  class=" d-block custom2 form-control mt-3 bg-white " type="text"  name="phone_number" placeholder="Phone number"></div>
